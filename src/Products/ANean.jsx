...
import {ANeanData} from "../Data";

export default function ANean() {
  return (
<>
<section className="ANeansection">
  ...
  <div className="ANeanContentDiv">
    <p>
      <h1>Idler Rollers</h1>
Hitech has been manufacturing Idler Rollers and Brackets as per Indian/International standards and of-course customized requirements too.Hitech's manufacturing facility covers Idlers for capacities between 50TPH to 8000TPH.
